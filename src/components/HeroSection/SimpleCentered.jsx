...
import SimpleCenteredCode from "./SimpleCenteredCode";
...
const SimpleCentered = () => {
  ...
  const handleClick = () => {
    return setShowCode((value) => !value);
  };
      ...
      <div className='bg-slate-200 max-w-full my-5  sm:flex sm:justify-center md:mt-8 p-5 rounded '>
        ...
        <div className='mt-3 rounded-md shadow sm:mt-0 sm:ml-3'>
          <button
            ...
            flex w-full items-left justify-center rounded-md border border-transparent bg-indigo-600 px-8 py-3 text-base font-medium text-white hover:bg-indigo-700 md:py-4 md:px-10 md:text-lg
